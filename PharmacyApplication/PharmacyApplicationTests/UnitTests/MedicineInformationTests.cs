...
namespace PharmacyApplicationTests
{
    public class MedicineInformationTests
    {
        ...
        private static IMedicineRepository CreateStubRepository()
        {
            ...
            Medicine panadol = new Medicine(2L, "Panadol", "Galenika", "sideEffects2", "usage2", new List<SubstituteMedicine>(), 400.00, 320.00, "mainPrecautions2", "potentialDangers2", new List<Substance>(), 500);

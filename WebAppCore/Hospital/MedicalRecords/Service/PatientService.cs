    ...
    public class PatientService
    {
        ...
        public bool Block(Patient patient)
        {
            ...
            patient = new Patient(patient.Id, patient.UserName, patient.Password, patient.FullName, patient.EMail, patient.Activated, patient.Gender,
                patient.Jmbg, patient.DateOfBirth, patient.Residence, patient.Phone, patient.PreferedDoctor, patient.Weight, patient.Height, patient.BloodType, true, patient.Appointments, patient.ProfileImage);

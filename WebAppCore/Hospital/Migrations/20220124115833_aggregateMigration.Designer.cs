...
namespace Hospital.Migrations
{
    ...
    [Migration("20220124115833_aggregateMigration")]
    partial class aggregateMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital.RoomsAndEquipment.Model.EquipmentTransportation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("EquipmentTransportationAggregates");
                });

            modelBuilder.Entity("Hospital.RoomsAndEquipment.Model.EquipmentTransportationEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("EquipmentTransportationId")
                        .HasColumnType("integer");

                    b.Property<string>("ReasonForTransportation")
                        .HasColumnType("text");

                    b.Property<DateTime>("TimeOfTransport")
                        .HasColumnType("timestamp without time zone");

                    b.HasKey("Id");

                    b.HasIndex("EquipmentTransportationId");

                    b.ToTable("EquipmentTransportationEvent");
                });
            ...
            modelBuilder.Entity("Hospital.Schedule.Model.Survey", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2022, 1, 24, 12, 58, 32, 614, DateTimeKind.Local).AddTicks(9332)
                        });
                });
            ...
            modelBuilder.Entity("Hospital.RoomsAndEquipment.Model.EquipmentTransportation", b =>
                {
                    b.HasOne("Hospital.RoomsAndEquipment.Model.Equipment", "Equipment")
                        .WithMany()
                        .HasForeignKey("EquipmentId");

                    b.HasOne("Hospital.RoomsAndEquipment.Model.Room", "RoomFrom")
                        .WithMany()
                        .HasForeignKey("RoomFromId");

                    b.HasOne("Hospital.RoomsAndEquipment.Model.Room", "RoomTo")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital.RoomsAndEquipment.Model.EquipmentTransportationEvent", b =>
                {
                    b.HasOne("Hospital.RoomsAndEquipment.Model.EquipmentTransportation", null)
                        .WithMany("Events")
                        .HasForeignKey("EquipmentTransportationId");
                });

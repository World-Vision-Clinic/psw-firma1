...
(
    ...
    "Areaid" integer,
    "MapPositionId" integer NOT NULL,
    CONSTRAINT "PK_Buildings" PRIMARY KEY (id),
    CONSTRAINT "FK_Buildings_Areas_Areaid" FOREIGN KEY ("Areaid")
...
ALTER TABLE public."Buildings"
    OWNER to admin;
-- Index: IX_Buildings_Areaid

-- DROP INDEX public."IX_Buildings_Areaid";

CREATE INDEX "IX_Buildings_Areaid"
...
INSERT INTO public."Buildings"(
	id, "Name", "Info", "Areaid", "MapPositionId")
	VALUES (1,'Hospital I' , 'Gynecology',null,1);

INSERT INTO public."Buildings"(
	id, "Name", "Info", "Areaid", "MapPositionId")
	VALUES (2,'Hospital II','Oftamology', null,2);

-- Table: public.FloorLabels

-- DROP TABLE public."FloorLabels";

CREATE TABLE IF NOT EXISTS public."FloorLabels"
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    "X" integer NOT NULL,
    "Y" integer NOT NULL,
    ...
    CONSTRAINT "PK_FloorLabels" PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE public."FloorLabels"
    OWNER to admin;

INSERT INTO public."FloorLabels"(
	id, "X", "Y", "Text", "FloorId")
	VALUES (1,50,80,'ENTRACE',1);
...
INSERT INTO public."Floors"(
	"Id", "Level", "Info", "BuildingId")
	VALUES (1, 'Ground floor', '', 1);

INSERT INTO public."Floors"(
	"Id", "Level", "Info", "BuildingId")
	VALUES (2,'First floor','',1);

-- Table: public.MapPositions

-- DROP TABLE public."MapPositions";

CREATE TABLE IF NOT EXISTS public."MapPositions"
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    "X" integer NOT NULL,
    "Y" integer NOT NULL,
    "Height" integer NOT NULL,
    "Width" integer NOT NULL,
    CONSTRAINT "PK_MapPositions" PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE public."MapPositions"
    OWNER to admin;

INSERT INTO public."MapPositions"(
	id, "X", "Y", "Height", "Width")
	VALUES (1, 30, 20, 180, 520);

INSERT INTO public."MapPositions"(
	id, "X", "Y", "Height", "Width")
	VALUES (2, 30, 460, 180, 520);

-- Table: public.OutsideDoors

-- DROP TABLE public."OutsideDoors";

CREATE TABLE IF NOT EXISTS public."OutsideDoors"
(
    id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    "X" integer NOT NULL,
    "Y" integer NOT NULL,
    ...
    "MapPositionId" integer NOT NULL,
    CONSTRAINT "PK_OutsideDoors" PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE public."OutsideDoors"
    OWNER to admin;

INSERT INTO public."OutsideDoors"(
	id, "X", "Y", "IsVertical", "MapPositionId")
	VALUES (1,545,80,true,1);

INSERT INTO public."OutsideDoors"(
	id, "X", "Y", "IsVertical", "MapPositionId")
	VALUES (2, 260, 195, false, 1);

INSERT INTO public."OutsideDoors"(
	id, "X", "Y", "IsVertical", "MapPositionId")
	VALUES (3, 545, 505, true, 2);

INSERT INTO public."OutsideDoors"(
	id, "X", "Y", "IsVertical", "MapPositionId")
	VALUES (4, 260, 455, false, 2);

-- Table: public.AllEquipment

-- DROP TABLE public."AllEquipment";

CREATE TABLE IF NOT EXISTS public."AllEquipment"
(
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    "Name" text COLLATE pg_catalog."default",
    "Type" integer NOT NULL,
    ...
    "InTransport" boolean NOT NULL,
    "TransportStart" timestamp without time zone NOT NULL,
    "TransportEnd" timestamp without time zone NOT NULL,
    CONSTRAINT "PK_AllEquipment" PRIMARY KEY ("Id")
)

TABLESPACE pg_default;

ALTER TABLE public."AllEquipment"
    OWNER to admin;
...
INSERT INTO public."Rooms"( "Id", "Name", "Purpose", "DoctorId", "FloorId", "X", "Y", "Height", "Width", "DoorX", "DoorY", "Vertical", "Css", "DoorExist")
	VALUES (1,'OPERATING ROOM 1','',-1,1,0,150,190,150,148,285,true,'room room-cadetblue',true);
